function [q] = comp_flux_gen(flux,res,u,Grid,BC) %update for 2D
% author: Marc Hesse
% date: 22 Feb 2019
% Description:
...
%sign =ismember(dof_face,[Grid.dof_f_xmin;Grid.dof_f_ymin])-ismember(dof_face,[Grid.dof_f_xmax;Grid.dof_f_ymax]);
