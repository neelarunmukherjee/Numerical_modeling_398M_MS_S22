...
Grid.dx = (Grid.xmax-Grid.xmin)/Grid.Nx;        % dx of the gridblocks
...
Grid.xc = A.'; % x-coords of gridblock centers
B = linspace(Grid.xmin, Grid.xmax, Grid.Nfx);
Grid.xf = B.'; % x-coords of gridblock faces
